...
import { putSuppliercontact, getSuppliercontact } from '@/api/suppliercontact'
...
export default {
  ...
  methods: {
    async getSuppliercontact() {
      const res = await getSuppliercontact(this.$route.query.id)
      this.suppliercontactForm = res.data
    },

    async putSuppliercontact() {
      await putSuppliercontact(this.$route.query.id, this.suppliercontactForm)
